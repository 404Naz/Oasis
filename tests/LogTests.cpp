...
TEST_CASE("IndefiniteIntegral of Natural Log", "[IndefiniteIntegral][Log][Euler]")
{
    Oasis::IndefiniteIntegral int1{Oasis::Log{Oasis::EulerNumber{}, Oasis::Variable{"x"}}, Oasis::Variable{"x"}};
    Oasis::IndefiniteIntegral int2{Oasis::Log{Oasis::EulerNumber{}, Oasis::Multiply{Oasis::Real{5}, Oasis::Variable{"x"}}}, Oasis::Variable{"x"}};
...
TEST_CASE("IndefiniteIntegral of Non-Natural variable base Log", "[IndefiniteIntegral][Log][Variable]")
{
    Oasis::IndefiniteIntegral int1{Oasis::Log{Oasis::Variable{"y"}, Oasis::Variable{"x"}}, Oasis::Variable{"x"}};
    Oasis::IndefiniteIntegral int2{Oasis::Log{Oasis::Variable{"y"}, Oasis::Multiply{Oasis::Real{5}, Oasis::Variable{"x"}}}, Oasis::Variable{"x"}};
    Oasis::IndefiniteIntegral intEq{Oasis::Log{Oasis::Variable{"x"}, Oasis::Variable{"x"}}, Oasis::Variable{"x"}};
...
TEST_CASE("IndefiniteIntegral of Non-natural real base log", "[IndefiniteIntegral][Log][Variable]")
{
    Oasis::IndefiniteIntegral int1{Oasis::Log{Oasis::Real{10}, Oasis::Variable{"x"}}, Oasis::Variable{"x"}};
    Oasis::IndefiniteIntegral int2{Oasis::Log{Oasis::Real{10}, Oasis::Multiply{Oasis::Real{5}, Oasis::Variable{"x"}}}, Oasis::Variable{"x"}};
